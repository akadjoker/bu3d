...
public:
    ...
    static void SetCursorRelative(bool state);
    static void SetVisible(bool state);

    static u32 GetMouseState(int *x, int *y);
    static u32 GetMouseStateRelative(int *x, int *y);
    static u32 GetMouseStateGlobal(int *x, int *y);
